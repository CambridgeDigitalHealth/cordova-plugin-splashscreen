    ...
    private void showSplashScreen(final boolean hideAfterDelay) {
        ...
        cordova.getActivity().runOnUiThread(new Runnable() {
            public void run() {
                ...
                String statusBarColor = preferences.getString("SplashStatusBarBackgroundColor", "#00000000");
                if (statusBarColor != null && !statusBarColor.isEmpty() && Build.VERSION.SDK_INT >= 19) {
                    ...
                    try {
                        ...
                        dialogWindow.getClass().getDeclaredMethod("setStatusBarColor", int.class).invoke(dialogWindow, Color.parseColor(statusBarColor));
                ...
                String navigationBarColor = preferences.getString("SplashNavigationBarBackgroundColor", "#00000000");
                ...
                if (navigationBarColor != null && !navigationBarColor.isEmpty() && Build.VERSION.SDK_INT >= 19) {
                    ...
                    try {
                        // Using reflection makes sure any 5.0+ device will work without having to compile with SDK level 21
                        dialogWindow.getClass().getDeclaredMethod("setNavigationBarColor", int.class).invoke(dialogWindow, Color.parseColor(navigationBarColor));
                    } catch (Exception ignore) {
                        // this should not happen, only in case Android removes this method in a version > 21
